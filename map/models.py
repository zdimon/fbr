...
class Structure(models.Model):
  ...
  #      return '%s  (%s)' % (self.structure,self.fuel_moisture)
    ...
    @property
    def color_repr(self):objects = models.GeoManager()
...
class Vegetation(models.Model):
    ...
    veg = models.DecimalField(_(u'Veg'), max_digits=10, decimal_places=5, null=True, blank=True)objects = models.GeoManager()
