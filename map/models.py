...
class Vegetation(models.Model):
    ...
    veg_ = models.DecimalField(_(u'Veg'), max_digits=10, decimal_places=5, null=True, blank=True)
    veg_id = models.DecimalField(_(u'Veg'), max_digits=10, decimal_places=5, null=True, blank=True)
    veg_sp_1 = models.CharField(_(u'Veg_sp_1'), max_kength=25, null=True, blank=True)
    veg_sp_2 = models.CharField(_(u'Veg_sp_1'), max_kength=25, null=True, blank=True)
    veg_sp_3 = models.CharField(_(u'Veg_sp_1'), max_kength=25, null=True, blank=True) 
    structure = models.CharField(_(u'Veg_sp_1'), max_kength=20, null=True, blank=True)
    ...
    state = models.CharField(_(u'State'), max_kength=6, null=True, blank=True)
    fueltype = models.IntegerField(_(u'Fuel type'), null=True, blank=True)
    fuelcode_v = models.CharField(_(u'Fuel code'), max_kength=50, null=True, blank=True)
