...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Ndvi001250'
        db.create_table(u'map_ndvi001250', (
        ...
        db.send_create_signal(u'map', ['Ndvi001250'])


    def backwards(self, orm):
        # Deleting model 'Ndvi001250'
        db.delete_table(u'map_ndvi001250')
