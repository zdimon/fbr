...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slope.effectiv'
        db.add_column(u'map_slope', 'effectiv',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['map.Effectiveness'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slope.effectiv'
        db.delete_column(u'map_slope', 'effectiv_id')
