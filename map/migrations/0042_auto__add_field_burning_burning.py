...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Burning.burning'
        db.add_column(u'map_burning', 'burning',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Burning.burning'
        db.delete_column(u'map_burning', 'burning')


    models = {
        u'map.burning': {
            'Meta': {'object_name': 'Burning'},
            'burning': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
