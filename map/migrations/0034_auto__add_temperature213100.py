...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Temperature213100'
        db.create_table(u'map_temperature213100', (
        ...
        db.send_create_signal(u'map', ['Temperature213100'])


    def backwards(self, orm):
        # Deleting model 'Temperature213100'
        db.delete_table(u'map_temperature213100')
