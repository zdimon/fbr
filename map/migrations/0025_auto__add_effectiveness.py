...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Effectiveness'
        db.create_table(u'map_effectiveness', (
            ('gid', self.gf('django.db.models.fields.IntegerField')(primary_key=True, db_index=True)),
            ('effectiveness', self.gf('django.db.models.fields.CharField')(default='', max_length=10, null=True, blank=True)),
            ('color', self.gf(u'colorful.fields.RGBColorField')()),
        ))
        db.send_create_signal(u'map', ['Effectiveness'])


    def backwards(self, orm):
        # Deleting model 'Effectiveness'
        db.delete_table(u'map_effectiveness')
