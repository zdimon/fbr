...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cotter.veg_key4'
        db.add_column(u'map_cotter', 'veg_key4',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cotter.veg_key4'
        db.delete_column(u'map_cotter', 'veg_key4')
    ...
    models = {
        u'map.cotter': {
            ...
            'veg_key4': ('django.db.models.fields.IntegerField', [], {}),
