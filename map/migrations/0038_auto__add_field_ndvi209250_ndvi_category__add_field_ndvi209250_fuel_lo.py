...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ndvi209250.ndvi_category'
        db.add_column(u'map_ndvi209250', 'ndvi_category',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ndvi209250.fuel_load'
        db.add_column(u'map_ndvi209250', 'fuel_load',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ndvi209250.ndvi_category'
        db.delete_column(u'map_ndvi209250', 'ndvi_category')

        # Deleting field 'Ndvi209250.fuel_load'
        db.delete_column(u'map_ndvi209250', 'fuel_load')
