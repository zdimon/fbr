...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DroughtIndex'
        db.create_table(u'map_droughtindex', (
            ('gid', self.gf('django.db.models.fields.IntegerField')(primary_key=True, db_index=True)),
            ('month', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['map.Month'], null=True, blank=True)),
            ('value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=2, decimal_places=1, blank=True)),
        ))
        db.send_create_signal(u'map', ['DroughtIndex'])

        # Adding M2M table for field direction on 'DroughtIndex'
        m2m_table_name = db.shorten_name(u'map_droughtindex_direction')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('droughtindex', models.ForeignKey(orm[u'map.droughtindex'], null=False)),
            ('direction', models.ForeignKey(orm[u'map.direction'], null=False))
        ))
        db.create_unique(m2m_table_name, ['droughtindex_id', 'direction_id'])


    def backwards(self, orm):
        # Deleting model 'DroughtIndex'
        db.delete_table(u'map_droughtindex')

        # Removing M2M table for field direction on 'DroughtIndex'
        db.delete_table(db.shorten_name(u'map_droughtindex_direction'))
    ...
    models = {
        ...
        u'map.droughtindex': {
            ...
            'direction': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['map.Direction']", 'null': 'True', 'blank': 'True'}),
            'gid': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True', 'db_index': 'True'}),
