...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Temperature001100'
        db.create_table(u'map_temperature001100', (
        ...
        db.send_create_signal(u'map', ['Temperature001100'])


    def backwards(self, orm):
        # Deleting model 'Temperature001100'
        db.delete_table(u'map_temperature001100')
