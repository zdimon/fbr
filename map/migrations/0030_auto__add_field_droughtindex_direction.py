...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DroughtIndex.direction'
        db.add_column(u'map_droughtindex', 'direction',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['map.Direction'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'DroughtIndex.direction'
        db.delete_column(u'map_droughtindex', 'direction_id')
