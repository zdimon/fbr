...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cotter.myf'
        db.add_column(u'map_cotter', 'myf',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cotter.myf'
        db.delete_column(u'map_cotter', 'myf')
    ...
    models = {
        u'map.cotter': {
            ...
            'myf': ('django.db.models.fields.IntegerField', [], {}),
