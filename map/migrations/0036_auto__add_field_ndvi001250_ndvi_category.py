...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ndvi001250.ndvi_category'
        db.add_column(u'map_ndvi001250', 'ndvi_category',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ndvi001250.ndvi_category'
        db.delete_column(u'map_ndvi001250', 'ndvi_category')
