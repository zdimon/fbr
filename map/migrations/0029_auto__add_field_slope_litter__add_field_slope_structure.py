...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slope.litter'
        db.add_column(u'map_slope', 'litter',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Slope.structure'
        db.add_column(u'map_slope', 'structure',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slope.litter'
        db.delete_column(u'map_slope', 'litter')

        # Deleting field 'Slope.structure'
        db.delete_column(u'map_slope', 'structure')
