...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slope.effectiveness_category'
        db.add_column(u'map_slope', 'effectiveness_category',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slope.effectiveness_category'
        db.delete_column(u'map_slope', 'effectiveness_category')
